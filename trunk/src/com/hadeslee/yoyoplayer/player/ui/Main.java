...
import com.hadeslee.yoyoplayer.player.BasicPlayer;
import com.hadeslee.yoyoplayer.setting.AboutPanel;
import com.hadeslee.yoyoplayer.util.Config;
import com.hadeslee.yoyoplayer.util.DragMoveAdapter;
...
//    private RoundRectangle2D.Float rectPl,  rectLrc;
    ...
    public static void main(String[] args) {
        try {
            ...
            lm.readConfiguration(Main.class.getResourceAsStream("/com/hadeslee/yoyoplayer/util/Log.properties"));
    ...
    public void loadJS() {
        ...
        if (mixers != null) {
            ...
            log.log(Level.INFO, "Config.Mixer=" + mixer);
